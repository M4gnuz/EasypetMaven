 ...
 * @author alanfelipe
 */
@WebServlet(name = "AlterarQuantidadeCarrinhoServlet", urlPatterns = {"/AlterarQuantidadeCarrinhoServlet"})
public class AlterarQuantidadeCarrinhoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for(ItemCarrinho item: carrinho){
            if(item.getProduto().getId() == idProduto){
                ...
                } else if (quantidade > item.getProduto().getEstoque()){
