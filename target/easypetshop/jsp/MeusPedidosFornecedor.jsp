    ...
    <body id="tudo">
        ...
        <div class="container">
            <div id="logocentral" class="principal2 col-xs-12 col-sm-8 col-md-8">
                <h1 id="nomeTopo">Gerenciar meus Pedidos</h1>
            </div>
        </div>
        ...
        <div class="principal col-xs-12 col-sm-6 col-md-6">
            ...
            <br>
            <table class="table" id="tabela_busca_meus_pedidos_fornecedor">
                ...
                <tbody>                    
                    <%
                        ...
                        p.getPedidosFornecedor(lista,listaCliente,id);
                        ...
                        for (int contador = 0; contador < lista.size(); contador++) {
                            ...
                            out.print("<tr>"
                                    ...
                                    + "<td style='text-align: center'>" + listaCliente.get(contador).getNome() + "</td>"
                                    + "<td style='text-align: center'>" + p2.getStatus() + "</td>"
                                    + "<td style='text-align: center'><a href='../Controle?id=" + p2.getIdPedido()+ "&action=verDetalhesFornecedor'id='verDetalhes" + contador
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            $("#tabela_busca_meus_pedidos_fornecedor").dataTable({
                "language": {
