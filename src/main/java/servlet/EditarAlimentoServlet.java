 ...
 * @author glima
 */
public class EditarAlimentoServlet extends HttpServlet {
...
Alimento produto = new Alimento();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            produto.setNomeIngrediente(request.getParameter("ingredientes"));
            ...
            produto.setId(id);
            AlimentoDAO.alteraProduto(produto);
            
            out.print("alert('Alteração Concluída!')");
           response.sendRedirect("jsp/EditarAlimento.jsp?question=imagem&idEdit="+produto.getId());     
