...
<html>
    <head>
        ...
        <title>Cadastro Pet - imagem</title>
        ...
        <div class="container" id="quemSomos">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <h4 class="titulo">Adicione 1 foto do seu Pet!</h4>
  ...
  $(function () {
            ...
            <% if (status.equals("OKedit")) { %>
                alert("Seleciona uma nova imagem para seu PET.");
            <%}%>
            <%}%>
                ...
                document.getElementById("enviarImagem").onclick = function () {                    
                    ...
                    if (document.getElementById("target").src==window.location.href) {
                        ...
                        window.location.href = "MeusPets.jsp?status=OK";
                    }
                };

                document.getElementById("cancelarCadImagem").onclick = function () {
                    <% if (status.equals("OKedit")){ %>
                         window.location.href = "MeusPets.jsp";
                     <%}else{%>
                    window.location.href = "../Controle?action=delPet&id=<%=idProduto%>";
                    <%} %>
                };
            };
        </script>
