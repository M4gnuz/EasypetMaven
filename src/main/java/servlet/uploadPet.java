 ...
 * @author glima
 */
public class uploadPet extends HttpServlet {

	private static final long serialVersionUID = -3183701880292999570L;

	public String decodeToImage(String imageString, int idCliente, int idPet) {
        String path = "";
        ...
        try {
            ...
            File imgOutFile = new File(projectPath + "src\\main\\webapp\\ImagemProduto/imgPet-" + idCliente +"-"+idPet+ ".jpeg");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int idPet = Integer.parseInt(request.getParameter("id"));
               int idCliente  = 0; 
            ...
            String imagem = decodeToImage(foto, idCliente, idPet);
            ...
            PetDAO.addImagemPet(idPet, exibir2);
            if (status != null && status.equals("OK")) {
                response.sendRedirect("jsp/Home.jsp?status=OK");
